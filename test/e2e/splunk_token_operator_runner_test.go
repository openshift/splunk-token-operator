...
const (
	...
	jUnitOutputFilename  = "junit-splunk-token-operator.xml"
)

// Test entrypoint. osde2e runs this as a test suite on test pod.
func TestSplunkTokenOperator(t *testing.T) {
	...
	RunSpecs(t, "Splunk Token Operator", suiteConfig, reporterConfig)
}
